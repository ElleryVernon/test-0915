      ...
      <div className="login-actions">
        ...
        {providers.length > 0 && (
          <div className="grid gap-2">
            ...
            {providers.map((p) => {
              const name = (
                { kakao: '카카오', naver: '네이버', google: 'Google', apple: 'Apple' } as Record<
                  string,
                  string
                >
              )[p];
...
function NotificationsScreen({ data, navigate, back, refresh, toast }: ScreenProps) {
  return (
    <>
      <ScreenHeader
        title="알림"
        ...
        <div className="app-shell">
          ...
          >
            {base === '/settings/learning' ? (
              ...
              <NotificationsScreen key={screen} {...props} />
            ) : study ? (
